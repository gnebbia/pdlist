# -*- coding: utf-8 -*-
#
# pdlist documentation build configuration file, created by
...
latex_documents = [
  ('index', 'pdlist.tex', u'pdlist Documentation',
   u'gnc', 'manual'),
]
...
man_pages = [
    ('index', 'pdlist', u'pdlist Documentation',
     [u'gnc'], 1)
]
